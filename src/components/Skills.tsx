...
export default function Skills() {
  return (
    <div className="max-w-7xl p-6 md:p-12 md:px-20 w-full">
      <div className="mb-8">
        <h2 className="font-serif text-3xl md:text-3xl mb-2">Skills</h2>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 font-alt font-semibold text-base">
        <div className="border border-gray-200 dark:border-neutral-700 p-4 md:p-3 rounded-md flex gap-4 items-center">
